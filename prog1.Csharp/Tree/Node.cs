...
namespace Tree
{
    public class Node
    {
        ...
        public bool startsList = false;
        public virtual void flipInList(bool init){ }
        public virtual void flipFlag(){ }
        public virtual void setInList(bool b){ }
        public virtual void flipParentStartsList(){ }
        public virtual bool getStartsList()
        {
            return startsList;
        }
        ...
        public virtual Node getCar() {
            throw new System.ApplicationException("Cannot access car of a non-cons node.");
            return null;
        }
        public virtual Node getCdr() {
            throw new System.ApplicationException("Cannot access cdr of a non-cons node."); ;
            return null;
        }
        public virtual void setCar(Node a) {
            throw new System.ApplicationException("Cannot set car of a non-cons node.");
        }
        public virtual void setCdr(Node d) {
            throw new System.ApplicationException("Cannot set cdr of a non-cons node.");
        }
        public virtual String getName()
        {
            //throw new System.ApplicationException("Not an identifier.");
            return null;
        }
    }
}
